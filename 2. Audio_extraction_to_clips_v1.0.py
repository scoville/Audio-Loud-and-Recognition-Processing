...
##### Read Metadata timestamp file for all spike points, and extract AUDIO and VIDEO clips individually based on metadata, concatenate both into a clip mp4 file
